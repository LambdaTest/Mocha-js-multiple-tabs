# Run Mocha Multiple Tabs Tests on TestMu AI (Formerly LambdaTest)
...
This repository demonstrates how to handle multiple tabs in automation tests in Mocha.js on TestMu AI (Formerly TestMu AI (Formerly LambdaTest)). You can refer to sample test repo [here](https://github.com/LambdaTest/Mocha-selenium-sample).
