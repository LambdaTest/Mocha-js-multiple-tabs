# Handle Multiple Browser Tabs in Mocha Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can handle Multiple Browser Tabs in Mocha Tests across real browsers and operating systems.
